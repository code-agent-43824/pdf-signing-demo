...
Документ — план устранения проблем после аудита и история его раскатки;
текущее состояние проекта — в `docs/STATUS.md`.
...
- Поправка от 2026-09-24: проверки PR-8 шли в браузере без реальных
  расширений. В Firefox этот CSP блокировал inline-скрипты расширения
  «Адаптер Рутокен Плагин», и Рутокен в Firefox не работал до `83fb7e6`
  (разбор — в `docs/JOURNAL.md`).
...
Фактический набор гейтов — `.github/workflows/ci.yml` и
`docs/SUPPLY_CHAIN.md`; расхождения с этим списком — в `docs/STATUS.md`.
